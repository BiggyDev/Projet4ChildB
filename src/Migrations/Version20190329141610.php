 ...
 */
final class Version20190329141610 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__comment AS SELECT id, title, article, score FROM comment');
        ...
        $this->addSql('INSERT INTO comment (id, title, article, score) SELECT id, title, article, score FROM __temp__comment');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__historic AS SELECT id, detail, date, total FROM historic');
        ...
        $this->addSql('INSERT INTO historic (id, detail, date, total) SELECT id, detail, date, total FROM __temp__historic');
