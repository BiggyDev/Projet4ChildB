 ...
 */
final class Version20190329145158 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__historic AS SELECT id, detail, date, total FROM historic');
        $this->addSql('DROP TABLE historic');
        $this->addSql('CREATE TABLE historic (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, detail VARCHAR(255) NOT NULL, date DATETIME NOT NULL, total NUMERIC(5, 2) NOT NULL, client_id INTEGER DEFAULT NULL, provider_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO historic (id, detail, date, total) SELECT id, detail, date, total FROM __temp__historic');
        $this->addSql('DROP TABLE __temp__historic');
