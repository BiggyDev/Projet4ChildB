 ...
 */
final class Version20190401203018 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE users (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username VARCHAR(25) NOT NULL COLLATE BINARY, password VARCHAR(500) NOT NULL COLLATE BINARY, is_active BOOLEAN NOT NULL)');
