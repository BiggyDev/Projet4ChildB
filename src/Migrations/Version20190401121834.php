 ...
 */
final class Version20190401121834 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__admin AS SELECT id, admin_name, password, email FROM admin');
        $this->addSql('DROP TABLE admin');
        $this->addSql('CREATE TABLE admin (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, admin_name VARCHAR(255) NOT NULL COLLATE BINARY, password VARCHAR(255) NOT NULL COLLATE BINARY, email VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO admin (id, admin_name, password, email) SELECT id, admin_name, password, email FROM __temp__admin');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__admin AS SELECT id, admin_name, password, email FROM admin');
        $this->addSql('DROP TABLE admin');
        $this->addSql('CREATE TABLE admin (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, admin_name VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO admin (id, admin_name, password, email) SELECT id, admin_name, password, email FROM __temp__admin');
        $this->addSql('DROP TABLE __temp__admin');
        $this->addSql('DROP INDEX IDX_22B3542919EB6921');
