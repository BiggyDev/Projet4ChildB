 ...
 */
final class Version20190401072633 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__client AS SELECT id, name, lastname, email, password, token, created_at, updated_at, description, phone, status, gender, age, localisation FROM client');
        $this->addSql('DROP TABLE client');
        $this->addSql('CREATE TABLE client (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, lastname VARCHAR(255) NOT NULL COLLATE BINARY, email VARCHAR(255) NOT NULL COLLATE BINARY, password VARCHAR(255) NOT NULL COLLATE BINARY, token VARCHAR(255) NOT NULL COLLATE BINARY, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, description CLOB DEFAULT NULL COLLATE BINARY, phone INTEGER DEFAULT NULL, status VARCHAR(20) NOT NULL COLLATE BINARY, gender VARCHAR(20) NOT NULL COLLATE BINARY, age INTEGER NOT NULL, localisation CLOB DEFAULT NULL --(DC2Type:json)
        )');
        $this->addSql('INSERT INTO client (id, name, lastname, email, password, token, created_at, updated_at, description, phone, status, gender, age, localisation) SELECT id, name, lastname, email, password, token, created_at, updated_at, description, phone, status, gender, age, localisation FROM __temp__client');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE historic (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, detail VARCHAR(255) NOT NULL COLLATE BINARY, date DATETIME NOT NULL, total NUMERIC(5, 2) NOT NULL)');
        $this->addSql('DROP INDEX IDX_22B3542919EB6921');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__client AS SELECT id, name, lastname, email, password, token, created_at, updated_at, description, phone, status, gender, age, localisation FROM client');
        $this->addSql('DROP TABLE client');
        $this->addSql('CREATE TABLE client (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, token VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, description CLOB DEFAULT NULL, phone INTEGER DEFAULT NULL, status VARCHAR(20) NOT NULL, gender VARCHAR(20) NOT NULL, age INTEGER NOT NULL, localisation VARCHAR(100) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO client (id, name, lastname, email, password, token, created_at, updated_at, description, phone, status, gender, age, localisation) SELECT id, name, lastname, email, password, token, created_at, updated_at, description, phone, status, gender, age, localisation FROM __temp__client');
        $this->addSql('DROP TABLE __temp__client');
        $this->addSql('DROP INDEX IDX_9474526C19EB6921');
        $this->addSql('DROP INDEX IDX_9474526CA53A8AA');
