 ...
 */
final class Version20190405114616 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__client AS SELECT id, email, password, token, updated_at, description, phone, localisation, name, lastname, created_at, gender, age FROM client');
        ...
        , name VARCHAR(255) DEFAULT NULL COLLATE BINARY, lastname VARCHAR(255) DEFAULT NULL COLLATE BINARY, created_at DATETIME DEFAULT NULL, gender VARCHAR(20) DEFAULT NULL COLLATE BINARY, age INTEGER DEFAULT NULL, username VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO client (id, username, password, token, updated_at, description, phone, localisation, name, lastname, created_at, gender, age) SELECT id, email, password, token, updated_at, description, phone, localisation, name, lastname, created_at, gender, age FROM __temp__client');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE __temp__child');
        $this->addSql('CREATE INDEX IDX_22B3542919EB6921 ON child (client_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__client AS SELECT id, name, lastname, username, password, token, created_at, updated_at, description, phone, gender, age, localisation FROM client');
        $this->addSql('DROP TABLE client');
        ...
        $this->addSql('INSERT INTO client (id, name, lastname, email, password, token, created_at, updated_at, description, phone, gender, age, localisation) SELECT id, name, lastname, username, password, token, created_at, updated_at, description, phone, gender, age, localisation FROM __temp__client');
        $this->addSql('DROP TABLE __temp__client');
        $this->addSql('DROP INDEX IDX_9474526C19EB6921');
        $this->addSql('DROP INDEX IDX_9474526CA53A8AA');
        $this->addSql('CREATE TEMPORARY TABLE __temp__comment AS SELECT id, client_id, provider_id, title, article, score FROM comment');
