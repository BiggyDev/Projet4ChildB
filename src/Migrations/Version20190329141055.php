 ...
 */
final class Version20190329141055 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__child AS SELECT id, name, lastname, age, info, gender FROM child');
        ...
        $this->addSql('INSERT INTO child (id, name, lastname, age, info, gender) SELECT id, name, lastname, age, info, gender FROM __temp__child');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE child');
        $this->addSql('CREATE TABLE child (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, age INTEGER NOT NULL, gender VARCHAR(20) NOT NULL, info CLOB NOT NULL)');
